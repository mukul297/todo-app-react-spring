...
* The original package name 'com.100x.todo' is invalid and this project uses 'com._x.todo' instead.
...
* [Spring Data MongoDB](https://docs.spring.io/spring-boot/docs/3.2.7/reference/htmlsingle/index.html#data.nosql.mongodb)
